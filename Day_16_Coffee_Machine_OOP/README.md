...
## Project Overview
This project is a refactored version of the Day 15 Coffee Machine, completely rewritten using Object-Oriented Programming (OOP) principles. The main goal of this exercise was to learn how to import external modules, instantiate objects, and access their attributes and methods.

## Disclaimer & Credits
The underlying backend classes (`coffee_maker.py`, `money_machine.py`, and `menu.py`) were provided as part of the **"100 Days of Code™: The Complete Python Pro Bootcamp" by Angela Yu**. 
