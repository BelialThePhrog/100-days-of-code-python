...
| [Day&nbsp;25: Pandas & U.S. States Game](./Day_25_States_Game) | Exploratory Data Analysis (EDA) with Pandas (Squirrel Census) and an interactive geographic game using Turtle. | `Pandas`, `Data Analysis`, `Turtle GUI` |
---
