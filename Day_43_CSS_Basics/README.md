...
This project introduces Cascading Style Sheets (CSS) to separate content (HTML) from presentation. The objective is to style a Spanish color vocabulary list by linking an external CSS file, targeting specific elements using IDs and Classes, and adjusting image properties.

## Skills Demonstrated

* **External Stylesheets:** Linking a separate `style.css` file to the HTML document using the `<link>` tag to maintain clean and scalable code.
